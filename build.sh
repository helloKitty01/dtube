...
#BROKER="10.232.25.82"
NS_PORT=9876
TGZ_NAME=ict-dtube-3.0.0-SNAPSHOT.tar.gz
...
dispatch(){
	...
	pgm -b ${NS} ${BROKER} 'mv ict-dtube devenv'
...
cleanlog(){
	echo "############################# startup log #################################"
	pgm -b ${NS} ${BROKER} 'rm -rf dtubelogs'
}
