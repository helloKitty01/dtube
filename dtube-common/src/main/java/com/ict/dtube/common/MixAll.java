...
import com.ict.dtube.common.annotation.ImportantField;
 ...
 */
public class MixAll {
    public static final String DTUBE_HOME_ENV = "DTUBE_HOME";
    public static final String DTUBE_HOME_PROPERTY = "dtube.home.dir";
    public static final String NAMESRV_ADDR_ENV = "NAMESRV_ADDR";
    public static final String NAMESRV_ADDR_PROPERTY = "dtube.namesrv.addr";
    public static final String MESSAGE_COMPRESS_LEVEL = "dtube.message.compressLevel";
    public static final String WS_DOMAIN_NAME = System.getProperty("dtube.namesrv.domain",
        "jmenv.tbsite.net");
    public static final String WS_DOMAIN_SUBGROUP = System.getProperty("dtube.namesrv.domain.subgroup",
        "nsaddr");
    // http://jmenv.tbsite.net:8080/dtube/nsaddr
    public static final String WS_ADDR = "http://" + WS_DOMAIN_NAME + ":8080/dtube/" + WS_DOMAIN_SUBGROUP;
