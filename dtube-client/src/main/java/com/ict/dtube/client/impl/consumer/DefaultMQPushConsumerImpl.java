 ...
 */
package com.ict.dtube.client.impl.consumer;
...
import com.ict.dtube.client.QueryResult;
import com.ict.dtube.client.Validators;
...
import com.ict.dtube.client.consumer.listener.MessageListener;
import com.ict.dtube.client.consumer.listener.MessageListenerConcurrently;
import com.ict.dtube.client.consumer.listener.MessageListenerOrderly;
import com.ict.dtube.client.consumer.store.LocalFileOffsetStore;
import com.ict.dtube.client.consumer.store.OffsetStore;
import com.ict.dtube.client.consumer.store.ReadOffsetType;
import com.ict.dtube.client.consumer.store.RemoteBrokerOffsetStore;
import com.ict.dtube.client.exception.MQBrokerException;
import com.ict.dtube.client.exception.MQClientException;
import com.ict.dtube.client.hook.ConsumeMessageContext;
import com.ict.dtube.client.hook.ConsumeMessageHook;
import com.ict.dtube.client.hook.FilterMessageHook;
import com.ict.dtube.client.impl.CommunicationMode;
import com.ict.dtube.client.impl.MQClientManager;
import com.ict.dtube.client.impl.factory.MQClientInstance;
import com.ict.dtube.client.log.ClientLogger;
import com.ict.dtube.client.stat.ConsumerStatManager;
import com.ict.dtube.common.MixAll;
import com.ict.dtube.common.ServiceState;
import com.ict.dtube.common.UtilAll;
import com.ict.dtube.common.consumer.ConsumeFromWhere;
import com.ict.dtube.common.filter.FilterAPI;
import com.ict.dtube.common.help.FAQUrl;
import com.ict.dtube.common.message.Message;
import com.ict.dtube.common.message.MessageAccessor;
import com.ict.dtube.common.message.MessageConst;
import com.ict.dtube.common.message.MessageExt;
import com.ict.dtube.common.message.MessageQueue;
import com.ict.dtube.common.protocol.heartbeat.ConsumeType;
...
import com.ict.dtube.common.sysflag.PullSysFlag;
...
public class DefaultMQPushConsumerImpl implements MQConsumerInner {
    ...
    private final DtubePushConsumer defaultMQPushConsumer;
    // Rebalance实现
    ...
    public DefaultMQPushConsumerImpl(DtubePushConsumer defaultMQPushConsumer) {
    ...
    public DtubePushConsumer getDefaultMQPushConsumer() {
