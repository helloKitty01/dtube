 ...
 */
package com.ict.dtube.client.producer;
 ...
 * @author sky
 */
public class DtubeProducer extends ClientConfig implements MQProducer {
     ...
     */
    private volatile int defaultTopicQueueNums = 16;
    /**
     * 发送消息超时，不建议修改
     */
    ...
    public DtubeProducer() {
    }


    public DtubeProducer(final String producerGroup) {
