...
import com.ict.dtube.client.consumer.rebalance.AllocateMessageQueueAveragely;
 ...
 * @author sky
 */
public class DtubePushConsumer extends ClientConfig implements MQPushConsumer {
    ...
    public DtubePushConsumer() {

    }


    public DtubePushConsumer(final String consumerGroup) {
