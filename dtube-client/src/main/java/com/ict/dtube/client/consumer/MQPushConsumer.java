...
public interface MQPushConsumer extends MQConsumer {
     ...
     *            "dtube.message.filter.cousumergroup.FilterClassName"<br>
     *            "dtube.message.filter.cousumergroup.topic1.FilterClassName"<br>
     *            注意事项：<br>
     *            a、Java程序必须继承于com.ict.dtube.common.filter.MessageFilter，
     *            并实现相应的接口来过滤<br>
