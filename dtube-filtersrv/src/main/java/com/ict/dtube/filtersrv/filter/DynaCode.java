...
import com.ict.common.lang.ArrayUtil;
import com.ict.common.lang.StringUtil;
 ...
 * 
 * @author <a href="mailto:qihao@ict.com">qihao</a>
 * @version 1.0
 */
public class DynaCode {
     ...
     * 生成java文件的路径
     */
    private String sourcePath = System.getProperty("user.home") + FILE_SP + "dtube_filter_class" + FILE_SP
            + UtilAll.getPid();
